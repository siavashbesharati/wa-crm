...
def _load_or_create_instagram_connector_key() -> str:
    return _load_or_create_secret_file(
        _INSTAGRAM_CONNECTOR_KEY_FILE, "dev-instagram-connector-key-change-me", min_len=16
    )
...
class Settings(BaseSettings):
    ...
    # Fernet key for encrypting Baileys / Divar / Bale / Instagram auth state at rest
